...
public class Student {
    ...
    public Student(long createAt, long updateAt, String name, long QQ, String chosseStudyType, long roughlyStudyTime, String graduateSchool, long onlineStudyId, String dailyLink, String coachSenior, String declaration, String whereToKnow) {
        this.createAt = createAt;
        this.updateAt = updateAt;
        this.name = name;
        this.QQ = QQ;
